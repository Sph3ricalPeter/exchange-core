...
public abstract class OrderBookBaseTest {
    ...
    public void before() {
        ...
        processAndValidate(OrderCommand.newOrder(GTC, 0L, UID_2, INITIAL_PRICE, 0L, 13L, ASK, false), SUCCESS);
        processAndValidate(OrderCommand.cancel(0L, UID_2), SUCCESS);

        processAndValidate(OrderCommand.newOrder(GTC, 1L, UID_1, 81600L, 0L, 100L, ASK, false), SUCCESS);
        processAndValidate(OrderCommand.newOrder(GTC, 2L, UID_1, 81599L, 0L, 50L, ASK, false), SUCCESS);
        processAndValidate(OrderCommand.newOrder(GTC, 3L, UID_1, 81599L, 0L, 25L, ASK, false), SUCCESS);
        processAndValidate(OrderCommand.newOrder(GTC, 8L, UID_1, 201000L, 0L, 28L, ASK, false), SUCCESS);
        processAndValidate(OrderCommand.newOrder(GTC, 9L, UID_1, 201000L, 0L, 32L, ASK, false), SUCCESS);
        processAndValidate(OrderCommand.newOrder(GTC, 10L, UID_1, 200954L, 0L, 10L, ASK, false), SUCCESS);

        processAndValidate(OrderCommand.newOrder(GTC, 4L, UID_1, 81593L, 82000L, 40L, BID, false), SUCCESS);
        processAndValidate(OrderCommand.newOrder(GTC, 5L, UID_1, 81590L, 82000L, 20L, BID, false), SUCCESS);
        processAndValidate(OrderCommand.newOrder(GTC, 6L, UID_1, 81590L, 82000L, 1L, BID, false), SUCCESS);
        processAndValidate(OrderCommand.newOrder(GTC, 7L, UID_1, 81200L, 82000L, 20L, BID, false), SUCCESS);
        processAndValidate(OrderCommand.newOrder(GTC, 11L, UID_1, 10000L, 12000L, 12L, BID, false), SUCCESS);
        processAndValidate(OrderCommand.newOrder(GTC, 12L, UID_1, 10000L, 12000L, 1L, BID, false), SUCCESS);
        processAndValidate(OrderCommand.newOrder(GTC, 13L, UID_1, 9136L, 12000L, 2L, BID, false), SUCCESS);
    ...
    void clearOrderBook() {
        ...
        IOrderBook.processCommand(orderBook, OrderCommand.newOrder(IOC, 100000000000L, -1, MAX_PRICE, MAX_PRICE, askSum, BID, false));
...
//        log.debug("{}", orderBook.getL2MarketDataSnapshot(Integer.MAX_VALUE).dumpOrderBook());
        ...
        IOrderBook.processCommand(orderBook, OrderCommand.newOrder(IOC, 100000000001L, -2, 1, 0, bidSum, ASK, false));
...
//        log.debug("{}", orderBook.getL2MarketDataSnapshot(Integer.MAX_VALUE).dumpOrderBook());
    ...
    public void shouldAddGtcOrders() {
        ...
        IOrderBook.processCommand(orderBook, OrderCommand.newOrder(GTC, 93, UID_1, 81598, 0, 1, ASK, false));
        expectedState.insertAsk(0, 81598, 1);

        IOrderBook.processCommand(orderBook, OrderCommand.newOrder(GTC, 94, UID_1, 81594, MAX_PRICE, 9_000_000_000L, BID, false));
        ...
        IOrderBook.processCommand(orderBook, OrderCommand.newOrder(GTC, 95, UID_1, 130000, 0, 13_000_000_000L, ASK, false));
        expectedState.insertAsk(3, 130000, 13_000_000_000L);

        IOrderBook.processCommand(orderBook, OrderCommand.newOrder(GTC, 96, UID_1, 1000, MAX_PRICE, 4, BID, false));
    ...
    public void shouldIgnoredDuplicateOrder() {
        OrderCommand orderCommand = OrderCommand.newOrder(GTC, 1, UID_1, 81600, 0, 100, ASK, false);
    ...
    public void shouldMatchIocOrderPartialBBO() {
        ...
        // size=10
        OrderCommand cmd = OrderCommand.newOrder(IOC, 123, UID_2, 1, 0, 10, ASK, false);
        processAndValidate(cmd, SUCCESS);
    ...
    public void shouldMatchIocOrderFullBBO() {
        ...
        // size=40
        OrderCommand cmd = OrderCommand.newOrder(IOC, 123, UID_2, 1, 0, 40, ASK, false);
        processAndValidate(cmd, SUCCESS);
    ...
    public void shouldMatchIocOrderWithTwoLimitOrdersPartial() {
        ...
        // size=41
        OrderCommand cmd = OrderCommand.newOrder(IOC, 123, UID_2, 1, 0, 41, ASK, false);
        processAndValidate(cmd, SUCCESS);
    ...
    public void shouldMatchIocOrderFullLiquidity() {
        ...
        // size=175
        OrderCommand cmd = OrderCommand.newOrder(IOC, 123, UID_2, MAX_PRICE, MAX_PRICE, 175, BID, false);
        processAndValidate(cmd, SUCCESS);
    ...
    public void shouldMatchIocOrderWithRejection() {
        ...
        // size=270
        OrderCommand cmd = OrderCommand.newOrder(IOC, 123, UID_2, MAX_PRICE, MAX_PRICE + 1, 270, BID, false);
        processAndValidate(cmd, SUCCESS);
    ...
    public void shouldRejectFokBidOrderOutOfBudget() {
        ...
        OrderCommand cmd = OrderCommand.newOrder(FOK_BUDGET, 123L, UID_2, buyBudget, buyBudget, size, BID, false);
        processAndValidate(cmd, SUCCESS);
    ...
    public void shouldRejectFokAskOrderBelowExpectation() {
        ...
        OrderCommand cmd = OrderCommand.newOrder(FOK_BUDGET, 123L, UID_2, sellExpectation, sellExpectation, size, ASK, false);
        processAndValidate(cmd, SUCCESS);
    ...
    public void shouldFullyMatchMarketableGtcOrder() {
        ...
        // size=1
        OrderCommand cmd = OrderCommand.newOrder(GTC, 123, UID_2, 81599, MAX_PRICE, 1, BID, false);
        processAndValidate(cmd, SUCCESS);
    ...
    public void shouldPartiallyMatchMarketableGtcOrderAndPlace() {
        ...
        // size=77
        OrderCommand cmd = OrderCommand.newOrder(GTC, 123, UID_2, 81599, MAX_PRICE, 77, BID, false);
        processAndValidate(cmd, SUCCESS);
    ...
    public void shouldFullyMatchMarketableGtcOrder2Prices() {
        ...
        // size=77
        OrderCommand cmd = OrderCommand.newOrder(GTC, 123, UID_2, 81600, MAX_PRICE, 77, BID, false);
        processAndValidate(cmd, SUCCESS);
    ...
    public void shouldFullyMatchMarketableGtcOrderWithAllLiquidity() {
        ...
        // size=1000
        OrderCommand cmd = OrderCommand.newOrder(GTC, 123, UID_2, 220000, MAX_PRICE, 1000, BID, false);
        processAndValidate(cmd, SUCCESS);
    ...
    public void shouldMoveOrderFullyMatchAsMarketable() {
        ...
        OrderCommand cmd = OrderCommand.newOrder(GTC, 83, UID_2, 81200, MAX_PRICE, 20, BID, false);
        processAndValidate(cmd, SUCCESS);
    ...
    public void shouldMoveOrderFullyMatchAsMarketable2Prices() {
        ...
        OrderCommand cmd = OrderCommand.newOrder(GTC, 83, UID_2, 81594, MAX_PRICE, 100, BID, false);
        processAndValidate(cmd, SUCCESS);
    ...
    public void shouldMoveOrderMatchesAllLiquidity() {
        ...
        OrderCommand cmd = OrderCommand.newOrder(GTC, 83, UID_2, 81594, MAX_PRICE, 246, BID, false);
        processAndValidate(cmd, SUCCESS);
