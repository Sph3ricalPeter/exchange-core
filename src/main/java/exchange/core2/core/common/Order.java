...
/**
 * Extending OrderCommand allows to avoid creating new objects for instantly matching orders (MARKET
 * or marketable LIMIT orders) as well as use same code for matching moved orders
 *
 * <p>No external references allowed to such object - order objects only live inside OrderBook.
 */
@NoArgsConstructor
@AllArgsConstructor
@Builder
