...
public final class MatcherTradeEvent {
  ...
  public boolean matchedOrderHidden; // true if counter order was hidden
  ...
  public MatcherTradeEvent copy() {
    ...
    evt.matchedOrderHidden = this.matchedOrderHidden;
  ...
  public boolean equals(Object o) {
    ...
    return section == other.section
        ...
        && matchedOrderHidden == other.matchedOrderHidden
        && price == other.price
        && size == other.size
